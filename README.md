...
The `.receive()` method belongs to the [`EventHandler`](src/event-handler/) module which can be used standalone.
...
The `.on()` method belongs to the [`EventHandler`](src/event-handler/) module which can be used standalone.
...
The `.removeListener()` method belongs to the [`EventHandler`](src/event-handler/) module which can be used standalone.
...
<tr ><td class="name-td td_text"><a href="https://developer.github.com/v3/activity/events/types/#sponsorshipevent"><code>sponsorship</code></a></td><td class="actions-td td_text"><code>created</code><br><code>pending_tier_change</code></td></tr>
