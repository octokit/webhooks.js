...
| [`content_reference`](https://docs.github.com/en/developers/webhooks-and-events/webhooks/webhook-events-and-payloads#content_reference)                           | `created`                                                                                                                                                                                                                                                                                            |
...
| [`repository_vulnerability_alert`](https://docs.github.com/en/developers/webhooks-and-events/webhooks/webhook-events-and-payloads#repository_vulnerability_alert) | `create`<br>`dismiss`<br>`resolve`                                                                                                                                                                                                                                                                   |
...
| [`workflow_job`](https://docs.github.com/en/developers/webhooks-and-events/webhooks/webhook-events-and-payloads#workflow_job)                                     | `completed`<br>`in_progress`<br>`queued`<br>`started`                                                                                                                                                                                                                                                |
