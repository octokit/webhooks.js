...
The `.receive()` method belongs to the [`EventHandler`](event-handler/) module which can be used standalone.
...
The `.on()` method belongs to the [`EventHandler`](event-handler/) module which can be used standalone.
...
The `.removeListener()` method belongs to the [`EventHandler`](event-handler/) module which can be used standalone.
